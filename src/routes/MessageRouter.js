 ...
 */
router.post("/", validateBody(MessageSchema.createMessage), MessageController.createMessage)
/**
 * @swagger
 * /api/reviews/:id:
 *   put:
 ...
 *           <br> - ERROR_REVIEW_NOT_FOUND
 */
router.put("/:id", auth(), validateBody(MessageSchema.updateMessage), MessageController.updateMessage)
/**
 * @swagger
 * /api/reviews/:id:
 *   delete:
